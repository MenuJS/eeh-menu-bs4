angular.module('eehMenuBs4').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('template/eeh-menu-bs4/navbar/navbar.html',
    "<nav class=\"navbar eeh-menu eeh-menu-navbar\" ng-class=\"navClass\" style=\"background-color: #e3f2fd;\">\n" +
    "    <button class=\"navbar-toggler pull-right\" type=\"button\" ng-click=\"isCollapsed = !isCollapsed\">\n" +
    "        &#9776;\n" +
    "    </button>\n" +
    "    <eeh-menu-navbar-brand text=\"brandText\"\n" +
    "                                 state=\"brandState\"\n" +
    "                                 href=\"brandHref\"\n" +
    "                                 target=\"brandTarget\"\n" +
    "                                 src=\"brandSrc\"\n" +
    "                                 click=\"brandClick\"></eeh-menu-navbar-brand>\n" +
